...
<<<<<<< HEAD
    ...
    custom_weights[0] = 3       # ANGOLO: Cruciale per evitare micro-oscillazioni e mantenere il centro 5.0
    custom_weights[7:14] = 2    # LASER CENTRALI (Indici track centrali): Più importanza a cosa c'è dritto davanti 6.0
    custom_weights[20] = 2.5      # TRACKPOS: Forza il KNN a capire la sponda corretta in ingresso curva 2.5
    custom_weights[21] = 5.0      # SPEEDX: Peso massimo. Fondamentale per far capire al KNN quando staccare sul Corkscrew! 8.0
